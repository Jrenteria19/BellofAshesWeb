...
const translations = {
  es: {
    ...
    'installPWA.qrDesc': 'Escanea este código QR para descargar la APK de Bell of Ashes Comunidad. Es una app para la comunidad que te mantiene en contacto con los creadadores y con la comunidad del juego.',
